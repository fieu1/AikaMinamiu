 ...
 * @author MeiMei
 */
public class MainStdLL {

    public static void main(String[] args) throws Exception {
        Scanner sc = new Scanner(System.in);
        StdLinkedList data = new StdLinkedList();
        int menuCh;
        int repeat = 0;
        String nim = "", name = "", adr ="";
        do {
            ...
            switch (menuCh) { //selection
                ...
                case 3:
                    ...
                    if (subC == 1) { //condition
                        ...
                        String stdNim = sc.next(); //input student ID
                        try {
                            int idxKey = data.searchByKey(stdNim); //save index
                ...
                case 4:
                    ...
                    break; //end of menu 4
                case 5:
                    System.out.println("Thankyou!"); //print
