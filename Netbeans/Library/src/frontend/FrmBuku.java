...
public class FrmBuku extends javax.swing.JFrame {
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        Buku ann = new Buku();
        ann.setIdbuku(Integer.parseInt(txtIdBuku.getText()));
        ann.setKategori((Kategori)cmbKategori.getSelectedItem());
        ann.setJudul(txtJudul.getText());
        ann.setPenulis(txtPenulis.getText());
        ann.setPenerbit(txtPenerbit.getText());
        ann.save();
        txtIdBuku.setText(Integer.toString(ann.getIdbuku()));
        tampilkanData();
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        Buku ann = new Buku().getById(Integer.parseInt(model.getValueAt(row, 0).toString()));
        ann.delete();
        kosongkanForm();
        tampilkanData();
